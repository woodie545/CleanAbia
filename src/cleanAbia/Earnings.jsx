...
import { FaRegBell, FaRegCreditCard, FaRegClock } from 'react-icons/fa6'
...
export default function Earnings() {
  ...
  if (loading) {
    return (
      <main className='bg-[#E4EEE7] min-h-screen w-full px-4 sm:px-6 lg:px-8 py-6 flex items-center justify-center'>
        <p className='text-[#123A28] font-medium'>Loading earnings...</p>
      </main>
    )
  }
  ...
  return (
    <main className='bg-[#E4EEE7] min-h-screen w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8 overflow-x-hidden'>
      ...
      <section className='mt-6 w-full'>
        <Withdrawal availableBalance={earnings?.available || 0} />
      </section>
